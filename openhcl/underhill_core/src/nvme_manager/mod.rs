...
/// Returns whether the given PCI device requires fused keepalive device mode (all IO queues
/// pre-created at init and no admin queue commands after initialization).
